...
import pytest
from crawl_engine.agent import AgentConfig, run_agent
from crawl_engine.crawler import fetch_page
from crawl_engine.date_filter import detect_page_date, is_in_range
...
async def test_max_depth_zero_fetches_seed_only():
    ...
    with patch("crawl_engine.agent.fetch_page", wraps=fetch_page) as mock_fetch:
